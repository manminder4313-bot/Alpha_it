...
const DisplayMessage = ({ messageComponent }) => {
  ...
  return (
    <div style={{ border: '2px solid purple', padding: '15px', margin: '15px', borderRadius: '5px' }}>
      <h3>Message Display Area (DisplayMessage)</h3>
      {messageComponent}
    </div>
  );
};
...
const AddStudent = ({ onAddStudent }) => {
  ...
  return (
    <div style={{ border: '2px solid green', padding: '15px', margin: '15px', borderRadius: '5px' }}>
      <h3>Add New Student (AddStudent)</h3>
...
function StudentItem({ name, age, student, onDelete, onRateStudent }) {
...
const App = () => {
  ...
  const WelcomeMessage = <strong>Welcome to the Props Drilling </strong>;
